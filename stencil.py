...
if __name__=='__main__':
	...
	path = '/var/www/integralws.com/applications/integralws/views/appadmin.html'
	script = Web2pyStencil(path).compile()
	class container(dict):__getattr__,__setattr__,__delattr__ = dict.get,dict.__setitem__,dict.__delattr__
	g = dict(
		sys = sys,
		request = container(
			function = 'index',
